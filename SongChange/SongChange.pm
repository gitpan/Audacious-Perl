...
Audacious::SongChange - Take actions based on song track/time change
...
changes.  The thread is started via the I<Audacious::shell> command
...
protocol, audacious is consuming more cpu time than normal.
...
When I<Audacious::SongChange> is running, it will auto jump to the current 
track's I<jtime>, if any.

=item repeat

The I<Audacious::shell> I<repeat> command can be used with 2 additional
...
I<Audacious::SongChange> adds a new I<crop> command, which is similar in
...
When the I<SongChange> thread is running, the I<Audacious::shell> I<clear>
...
The I<Audacious::shell> I<history> command can be used to run a "script".
