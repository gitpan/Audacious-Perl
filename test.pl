...
my $config = Audacious::Config->new(Audacious::Config->file);
...
Afterwards, close audacious and run 'make test' again.
EOF
...
#but if audacious is already running, it may have been changed
{
